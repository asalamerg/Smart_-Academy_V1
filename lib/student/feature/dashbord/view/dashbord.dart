...
import 'package:smart_academy/student/feature/dashbord/view/item_dashbord.dart';
...
class Dashbord extends StatelessWidget {
  ...
  List<ModelDashboard> listDash = [
    ...
    ModelDashboard(
        ...
        basic: const Color(0xffF3F3F3),
        complete: "0% complete",
        primary: const Color(0xffE91E63)),
    ModelDashboard(
        name: "INTRODUCTION TO COMPUTER ORGANIZATION ",
        basic: const Color(0xffFAFAFA),
        complete: "0% complete",
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //   //   modelDashboard: listDash[index],
      //   // ),
      //   itemCount: listDash.length,
      // ),
      // Add IconButton at the bottom of the screen using a FloatingActionButton
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () {
          // Navigate to the CoursesScreen when the button is pressed
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) =>
                  CoursesScreen(), // Navigate to Courses Screen
            ),
          );
        },
